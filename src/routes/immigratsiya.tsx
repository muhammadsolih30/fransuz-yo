          ...
          <div className="grid md:grid-cols-3 gap-6">
            {eeBenefits.map((b, i) => (
              <div key={b.t} className="reveal card card-hover p-8 group" data-delay={i * 100}>
                ...
                <p className="text-[#15233B]/65 text-sm leading-relaxed">{b.d}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {requirements.map((r, i) => (
              <div key={r.title} className="reveal card card-hover p-8" data-delay={i * 100}>
                ...
                <ul className="flex flex-col gap-3">
                  {r.items.map((it) => (
                    <li key={it} className="flex items-start gap-3 text-sm text-[#15233B]/75">
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className={`text-sm font-semibold ${e.primary ? "text-[#d62839]" : "text-[#15233B]/55"}`}>{e.subtitle}</p>
                  </div>
                </div>
                <ul className="flex flex-col gap-3">
                  {e.items.map((it) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="reveal">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {crsFactors.map((c) => (
                  <span key={c} className="bg-[#FAF6EF] border border-[#15233B]/10 text-[#15233B]/75 text-sm font-semibold px-4 py-2 rounded-xl">
                    {c}
                  </span>
                ))}
              </div>
            ...
            <div className="reveal" data-delay={150}>
              <div className="card p-10 text-center bg-gradient-to-br from-white to-[#eaf0f8]">
                <p className="text-[#15233B]/55 text-sm font-semibold mb-3">O'rtacha vaziyatda (Fransuz B2–C1 + ingliz basic)</p>
                <div className="font-['Syne'] font-extrabold text-6xl lg:text-7xl text-gradient-canada mb-3">
                  400–470+
                </div>
                <p className="text-[#15233B]/50 text-sm font-medium">taxminiy CRS ball</p>
                <div className="mt-8 pt-8 border-t border-[#15233B]/8">
                  <div className="font-['Syne'] font-extrabold text-4xl text-[#15233B] mb-1">
                    <CountUp target={399} />
                  </div>
                  <p className="text-[#15233B]/55 text-sm">2025 dekabr — oxirgi saralash bali</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-[#FAF6EF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-14 reveal">
            ...
            <p className="text-[#15233B]/65 text-lg mt-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {itaTrend.map((k, i) => (
              <div key={k.year} className="reveal card card-hover p-8 text-center" data-delay={i * 80}>
                <div className="text-[#15233B]/50 text-sm font-semibold mb-3">{k.year}</div>
                <div className="font-['Syne'] font-extrabold text-4xl lg:text-5xl text-gradient-canada mb-2">
                  <CountUp target={k.n} suffix="+" />
                </div>
                <div className="text-[#15233B]/55 text-xs">ITA (taklif)</div>
              </div>
            ))}
          </div>
          <p className="text-center text-[#15233B]/55 text-sm mt-8 reveal">
