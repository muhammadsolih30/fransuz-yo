      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-10 pb-10 sm:pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-3">
            <h4 className="font-['Syne'] font-bold text-sm mb-4 sm:mb-5 text-white/90">Sahifalar</h4>
            <div className="flex flex-col gap-2.5 sm:gap-3">
              {pages.map((p) => (
                <Link
                  key={p.to}
                  to={p.to}
                  className="no-underline text-white/80 hover:text-[#E0A526] text-sm transition-colors w-fit"
                >
                  {p.label}
                </Link>
              ))}
